...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    if (numberEls.length)
      gsap.set(numberEls, { "--sm-num-opacity": 0 } as CSSVarObject);
  ...
  return (
    ...
    >
      <div
        ...
        style={
          accentColor
            ? ({ ["--sm-accent" as keyof CSSVarObject]: accentColor } as React.CSSProperties)
            : undefined
        }
      ...
      >
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative inline-flex items-center gap-2 bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto ${
          ...
          >
            <span
              ref={textWrapRef}
              className="sm-toggle-textWrap relative inline-block h-[1em] overflow-hidden whitespace-nowrap w-[var(--sm-toggle-width,auto)] min-w-[var(--sm-toggle-width,auto)] text-[20px] lg:text-[24px]"
              aria-hidden="true"
            >
              <span
                ref={textInnerRef}
            ...
            <span
              ref={iconRef}
              className="sm-icon relative w-[18px] h-[18px] lg:w-5 lg:h-5 shrink-0 inline-flex items-center justify-center [will-change:transform]"
              aria-hidden="true"
            >
              <span
                ref={plusHRef}
              ...
              <span
                ref={plusVRef}
                className="sm-icon-line sm-icon-line-v absolute left-1/2 top-1/2 w-full h-[2px] bg-current rounded-full -translate-x-1/2 -translate-y-1/2 [will-change:transform]"
              />
            </span>
          </button>
        </header>
